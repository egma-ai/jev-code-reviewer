...
Jev-Code-Reviewer replaces each file's diff on a GitHub pull request with plain-English **old logic → new logic**, a note on what changed, and the question a human should answer. **TypeSafe Jev** ranks each change P0/P1/P2 for attention; **OpenAI** writes the explanations. GitHub's page stays intact, and the original code is one toggle away.
